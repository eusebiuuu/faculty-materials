...
func exercise1() (RequestPayload3, string, error) {
	filename := "/home/eusebiuu/Documents/software_projects/distributed_systems/homework_1/client 3/input.txt"

	file, err := os.Open(filename)

	if err != nil {
		return RequestPayload3{}, "", fmt.Errorf("error opening file %s: %w", filename, err)
	}
	defer file.Close()
...
func main() {
	fmt.Println("The client 3 has connected")
