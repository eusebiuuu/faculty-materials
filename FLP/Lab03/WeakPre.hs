...
data Condition = Condition { condition :: BExpr, goals :: Maybe BExpr } -- goals = constrangeri
...
-- wlp (SSeq s1 s2) (Condition c1 g1) = wlp ()
wlp (SIf b s1 s2) (Condition c g) = Condition pre newGoals where -- try to use Nothing here
